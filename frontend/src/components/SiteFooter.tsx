...
import { IconFacebook, IconGlobe, IconInstagram, IconTikTok } from '@/components/icons';
...
const socialLinks = [
  ...
  { href: social.website, label: 'الموقع', Icon: IconGlobe },
] as const;
              ...
              <div className="mt-4 flex items-center gap-3">
                {socialLinks.map(({ href, label, Icon }) => (
                  <a
                    ...
                    aria-label={label}
                    className="flex h-10 w-10 items-center justify-center rounded-full border border-white/15 bg-white/5 text-white/80 transition hover:border-secondary hover:bg-white/10 hover:text-white"
                  >
