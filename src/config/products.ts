...
export const products: ProductConfig[] = [
  {
    ...
    category: 'sleep',
    format: 'gummies',
    targetCustomer: 'نساء وأهل الكويت اللي يتعبون ينامون بسبب التوتر والشغل',
    ...
    images: {
      ...defaultImages,
      ...productPageImagesFull('magnesium-sleep'),
      heroBeforeAfter: '/images/products/magnesium-sleep/product-hero.webp',
      heroProduct: '/images/products/magnesium-sleep/product-hero.webp',
    },
    imageAlts: {
  ...
  },
  {
    ...
    category: 'energy',
    format: 'gummies',
    targetCustomer: 'رجال ونساء في الكويت يحسون تعب وإرهاق يومي',
  ...
  },
  {
    ...
    category: 'cognitive',
    format: 'gummies',
    targetCustomer: 'طلاب وموظفين في الكويت — تشتت ونسيان',
    ...
    testimonials: [
      { quote: 'استخدمتها وقت الدراسة — أحس تركيزي صار أطول.', name: 'دانة', meta: 'الكويت • 22 سنة', initial: 'د' },
    ...
    insightStat: {
      value: '3',
      label: 'ساعات يضيعها الموظف الكويتي يومياً بسبب التشتت (تقدير)',
