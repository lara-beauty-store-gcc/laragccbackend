...
export const products: ProductConfig[] = [
  {
    ...
    category: 'sleep',
    format: 'gummies',
    targetCustomer: 'نساء وأهل الإمارات اللي يتعبون ينامون بسبب التوتر والشغل',
  ...
  },
  {
    ...
    testimonials: [
      { quote: 'استخدمتها وقت الدراسة — أحس تركيزي صار أطول.', name: 'دانة', meta: 'دبي • 22 سنة', initial: 'د' },
    ...
    insightStat: {
      value: '3',
      label: 'ساعات يضيعها الموظف يومياً بسبب التشتت (تقدير)',
